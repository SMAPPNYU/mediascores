...
namespace model_mediascores_domain_vb_namespace {
using stan::model::model_base_crtp;
using namespace stan::math;
stan::math::profile_map profiles__;
static constexpr std::array<const char*, 62> locations_array__ =
  {" (found before start of program)",
  " (in 'mediascores_domain_vb', line 11, column 2 to column 18)",
  " (in 'mediascores_domain_vb', line 12, column 2 to column 16)",
  " (in 'mediascores_domain_vb', line 13, column 2 to column 30)",
  " (in 'mediascores_domain_vb', line 14, column 2 to column 18)",
  " (in 'mediascores_domain_vb', line 15, column 2 to column 30)",
  " (in 'mediascores_domain_vb', line 17, column 2 to column 36)",
  " (in 'mediascores_domain_vb', line 18, column 2 to column 33)",
  " (in 'mediascores_domain_vb', line 19, column 2 to column 33)",
  " (in 'mediascores_domain_vb', line 21, column 2 to column 32)",
  " (in 'mediascores_domain_vb', line 22, column 2 to column 35)",
  " (in 'mediascores_domain_vb', line 23, column 2 to column 35)",
  " (in 'mediascores_domain_vb', line 24, column 2 to column 31)",
  " (in 'mediascores_domain_vb', line 25, column 2 to column 29)",
  " (in 'mediascores_domain_vb', line 57, column 2 to column 130)",
  " (in 'mediascores_domain_vb', line 58, column 2 to column 133)",
  " (in 'mediascores_domain_vb', line 59, column 2 to column 142)",
  " (in 'mediascores_domain_vb', line 30, column 9 to column 10)",
  " (in 'mediascores_domain_vb', line 30, column 2 to column 21)",
  " (in 'mediascores_domain_vb', line 31, column 9 to column 10)",
  " (in 'mediascores_domain_vb', line 31, column 12 to column 13)",
  " (in 'mediascores_domain_vb', line 31, column 2 to column 15)",
  " (in 'mediascores_domain_vb', line 32, column 2 to column 28)",
  " (in 'mediascores_domain_vb', line 33, column 2 to column 31)",
  " (in 'mediascores_domain_vb', line 34, column 2 to column 40)",
  " (in 'mediascores_domain_vb', line 35, column 2 to column 31)",
  " (in 'mediascores_domain_vb', line 36, column 2 to column 33)",
  " (in 'mediascores_domain_vb', line 38, column 2 to column 32)",
  " (in 'mediascores_domain_vb', line 39, column 2 to column 32)",
  " (in 'mediascores_domain_vb', line 40, column 2 to column 59)",
  " (in 'mediascores_domain_vb', line 41, column 2 to column 29)",
  " (in 'mediascores_domain_vb', line 42, column 2 to column 40)",
  " (in 'mediascores_domain_vb', line 44, column 4 to column 100)",
  " (in 'mediascores_domain_vb', line 43, column 16 to line 45, column 3)",
  " (in 'mediascores_domain_vb', line 43, column 2 to line 45, column 3)",
  " (in 'mediascores_domain_vb', line 46, column 2 to column 28)",
  " (in 'mediascores_domain_vb', line 47, column 2 to column 45)",
  " (in 'mediascores_domain_vb', line 50, column 6 to column 97)",
  " (in 'mediascores_domain_vb', line 49, column 18 to line 51, column 5)",
  " (in 'mediascores_domain_vb', line 49, column 4 to line 51, column 5)",
  " (in 'mediascores_domain_vb', line 52, column 4 to column 59)",
  " (in 'mediascores_domain_vb', line 48, column 16 to line 53, column 3)",
  " (in 'mediascores_domain_vb', line 48, column 2 to line 53, column 3)",
  " (in 'mediascores_domain_vb', line 2, column 2 to column 8)",
  " (in 'mediascores_domain_vb', line 3, column 2 to column 8)",
  " (in 'mediascores_domain_vb', line 4, column 2 to column 8)",
  " (in 'mediascores_domain_vb', line 5, column 12 to column 13)",
  " (in 'mediascores_domain_vb', line 5, column 2 to column 15)",
  " (in 'mediascores_domain_vb', line 6, column 8 to column 9)",
  " (in 'mediascores_domain_vb', line 6, column 11 to column 12)",
  " (in 'mediascores_domain_vb', line 6, column 2 to column 14)",
  " (in 'mediascores_domain_vb', line 7, column 2 to column 17)",
  " (in 'mediascores_domain_vb', line 11, column 9 to column 10)",
  " (in 'mediascores_domain_vb', line 14, column 9 to column 10)",
  " (in 'mediascores_domain_vb', line 17, column 20 to column 21)",
  " (in 'mediascores_domain_vb', line 21, column 9 to column 10)",
  " (in 'mediascores_domain_vb', line 22, column 9 to column 10)",
  " (in 'mediascores_domain_vb', line 23, column 20 to column 21)",
  " (in 'mediascores_domain_vb', line 24, column 9 to column 10)",
  " (in 'mediascores_domain_vb', line 57, column 9 to column 10)",
  " (in 'mediascores_domain_vb', line 58, column 9 to column 10)",
  " (in 'mediascores_domain_vb', line 59, column 9 to column 10)"};
#include <stan_meta_header.hpp>
class model_mediascores_domain_vb final : public model_base_crtp<model_mediascores_domain_vb> {
private:
  int N;
  int M;
  int G;
...
public:
  ~model_mediascores_domain_vb() {}
  model_mediascores_domain_vb(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_mediascores_domain_vb_namespace::model_mediascores_domain_vb";
    // suppress unused var warning
    (void) function__;
  ...
  inline std::string model_name() const final {
    return "model_mediascores_domain_vb";
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_mediascores_domain_vb_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
        ...
        for (int m = 1; m <= M; ++m) {
          ...
          lp_accum__.add(stan::math::neg_binomial_2_log_lpmf<propto__>(
                           stan::model::rvalue(Y, "Y",
                             ...
                             stan::model::index_uni(m)), lin_pred,
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_mediascores_domain_vb_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"alpha", "alpha_mu", "alpha_sigma",
                "gamma", "gamma_sigma", "omega_domain", "omega_domain_a",
...
using stan_model = model_mediascores_domain_vb_namespace::model_mediascores_domain_vb;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_mediascores_domain_vb_namespace::profiles__;
}
#endif
#endif
